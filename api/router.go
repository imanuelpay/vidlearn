...
func RegistrationPath(e *echo.Echo, controller Controller, config *config.AppConfig) {
	...
	playlistToolV1.DELETE("/playlist/:id/tool", controller.PlaylistToolV1Controller.DeletePlaylistTool, middleware.JWTMiddlewareAdmin(config))
	playlistToolV1.POST("/playlist/tool", controller.PlaylistToolV1Controller.CreatePlaylistTool, middleware.JWTMiddlewareAdmin(config))
